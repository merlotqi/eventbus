...
inline SyncEventBus& getSyncEventBus() {
    return SyncEventBusSingleton::instance();
}

inline void initializeSyncEventBus() {
    SyncEventBusSingleton::initialize();
}

inline void shutdownSyncEventBus() {
    SyncEventBusSingleton::shutdown();
}
