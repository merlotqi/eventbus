...
using PointerEventBus = eventbus::EventBus<eventbus::Synchronous,  // Synchronous execution
                                           eventbus::UnboundedQueue, eventbus::BlockProducer, DataProcessedEvent,
                                           ResourceAllocatedEvent, NotificationEvent>;
...
inline PointerEventBus& getPointerEventBus() { return PointerEventBusSingleton::instance(); }

inline void initializePointerEventBus() { PointerEventBusSingleton::initialize(); }

inline void shutdownPointerEventBus() { PointerEventBusSingleton::shutdown(); }
